 ...
 * @return   [description]
 */
std::string security_viid_service::makeRegisterMessage(const char* deviceId) {
    simple_xml sx;
 ...
 * @return   [description]
 */
std::string security_viid_service::makeUnregisterMessage(const char* deviceId) {
    simple_xml sx;
 ...
 * @return   [description]
 */
std::string security_viid_service::makeKeepaliveMessage(const char* deviceId) {
    simple_xml sx;
 ...
 * @return   [description]
 */
std::string security_viid_service::makeAPEListMessage(int minOccurs) {
    simple_xml sx;
