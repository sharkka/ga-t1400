...
public:
    ...
    int    add_images(const char* ip, int port, security_images_t& imageList);
    ...
    int    update_files(const char* ip, int port, security_images_t& imgList);
    ...
    int    add_persons(const char* ip, int port, security_persons_t& personList);
    int    update_persons(const char* ip, int port, security_persons_t& personList);
    int    delete_persons(const char* ip, int port, security_idlist_t& idList, std::string values);
    ...
    int    update_faces(const char* ip, int port, security_faces_t& faceList);
    int    delete_faces(const char* ip, int port, security_idlist_t& idList, std::string values);
    ...
    int    add_motorvehicles(const char* ip, int port, security_motorvehicles_t& motorvehicleList);
    int    update_motorvehicles(const char* ip, int port, security_motorvehicles_t& motorvehicleList);
    int    delete_motorvehicles(const char* ip, int port, security_idlist_t& idList, std::string values);
    ...
    int    add_nonmotorvehicles(const char* ip, int port, security_nonmotorvehicles_t& nvehicleList);
    int    update_nonmotorvehicles(const char* ip, int port, security_nonmotorvehicles_t& nvehicleList);
    int    delete_nonmotorvehicles(const char* ip, int port, security_idlist_t& idList, std::string values);
    ...
    int    add_things(const char* ip, int port, security_things_t& thingList);
    int    update_things(const char* ip, int port, security_things_t& thingList);
    int    delete_things(const char* ip, int port, security_idlist_t& idList, std::string values);
    ...
    int    add_scenes(const char* ip, int port, security_scenes_t& sceneList);
    int    update_scenes(const char* ip, int port, security_scenes_t& sceneList);
    int    delete_scenes(const char* ip, int port, security_idlist_t& idList, std::string values);
    ...
    int    add_cases(const char* ip, int port, security_cases_t& caseList);
    ...
    int    dispositions(const char* ip, int port, security_dispositions_t& dispList);
    ...
    int    delete_disposition(const char* ip, int port, security_idlist_t& idList, std::string values);
    int    undispositions(const char* ip, int port, const char* id);
    int    disposition_notifications(const char* ip, int port, security_disposition_notifys_t& dispnotiList);
    int    query_disposition_notification(const char* ip, int port, const char* key, const char* value);
    int    delete_disposition_notification(const char* ip, int port, security_idlist_t& idList, std::string values);
    int    subscribes(const char* ip, int port, security_subscribes_t& subscribeList);
    int    query_subscribes(const char* ip, int port, const char* key, const char* value);
    int    delete_subscribes(const char* ip, int port, security_idlist_t& idList, std::string values);
    int    unsubscribes(const char* ip, int port, const char* id);
    int    subscribe_notifications(const char* ip, int port, security_subscribe_notifys_t& subscribenotiList);
    int    query_subscribe_notifications(const char* ip, int port, const char* key, const char* value);
    int    delete_subscribe_notifications(const char* ip, int port, security_idlist_t& idList, std::string values);
    int    query_analysis_rules(const char* ip, int port, const char* key, const char* value);
    int    add_analysis_rules(const char* ip, int port, security_analysis_rules_t& analysisRuleList);
    int    update_analysis_rules(const char* ip, int port, security_analysis_rules_t& analysisRuleList);
    ...
    int    add_video_labels(const char* ip, int port, security_videolabels_t& videoLabelList);
    int    update_video_labels(const char* ip, int port, security_videolabels_t& videoLabelList);
    int    delete_video_labels(const char* ip, int port, security_idlist_t& idList, std::string values);
